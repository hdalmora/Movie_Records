...
/**
 * Created by Henrique Dal' Mora R. da Silva on 24/10/2016.
 */

public class GamesListaFavoritosActivity extends AppCompatActivity implements View.OnClickListener{

    public static final String LOG_TAG = GamesListaFavoritosActivity.class.getSimpleName();
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message.equalsIgnoreCase("adicionado")){
                ...
                tv_show_count.setText(countRecords() + " Games favoritos");
    ...
    BroadcastReceiver mThemeMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message.equals("themeChanged")){
                ...
                GamesListaFavoritosActivity.this.recreate();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_games_lista_favoritos);
        ...
        fab_go_to_top = (FloatingActionButton) findViewById(R.id.fab_go_to_top_game_favoritos);
        fab_go_to_top.hide();
        fab_go_to_top.setOnClickListener(this);

        tv_show_count = (TextView) findViewById(R.id.favoritos_games_count_texview);
        tv_show_count.setText(countRecords() + " Games favoritos");


        mRecyclerView = (RecyclerView) findViewById(R.id.favorite_games_recycler_view);
    ...
    public int countRecords() {
        return new TableControllerMovie(this).count("game");
    }
    ...
    public void readRecords(String sortStr) {
        ...
        List<MovieDataStructure> movies = new TableControllerMovie(this).read("game", sortStr);
        ...
        if (movies.size() > 0) {
            ...
            for (MovieDataStructure obj : movies) {
                ...
                mListStructure.add(new MovieDataStructure(null, movieTitle, movieYearRelease, movieType, moviePoster, movieImdbId, moviePlot,
                        "", 1, movieBGUrl, movieImdbRating, movieTomatoeRating, movieMetaScoreRating, movieDuration, movieGenero,
                        movieDiretor, movieEscritor, movieAtores, movieIdioma, moviePais, moviePremiacoes, movieDate, movieIsWatched, movieDateWatched));
                mRecyclerAdapter.notifyDataSetChanged();
            }
    ...
    public void onClick(View v) {
        ...
        switch(id){
            case R.id.fab_go_to_top_game_favoritos:
