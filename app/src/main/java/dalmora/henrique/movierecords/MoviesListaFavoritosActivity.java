...
public class MoviesListaFavoritosActivity extends AppCompatActivity implements View.OnClickListener{
    public static final String LOG_TAG = MoviesListaFavoritosActivity.class.getSimpleName();
    ...
    BroadcastReceiver mThemeMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message.equals("themeChanged")){
                ...
                MoviesListaFavoritosActivity.this.recreate();
            }
        }
    };
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message.equalsIgnoreCase("adicionado")){
                mListStructure.clear();
                readRecords(mSortStr);
                tv_show_count.setText(countRecords() + " Filmes favoritos");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movies_lista_favoritos);
        ...
        fab_go_to_top = (FloatingActionButton) findViewById(R.id.fab_go_to_top_movie_favoritos);
        fab_go_to_top.hide();
        fab_go_to_top.setOnClickListener(this);

        tv_show_count = (TextView) findViewById(R.id.favoritos_files_count_texview);
        tv_show_count.setText(countRecords() + " Filmes favoritos");


        mRecyclerView = (RecyclerView) findViewById(R.id.favorite_movies_recycler_view);
    ...
    public int countRecords() {
        return new TableControllerMovie(this).count("movie");
    }
    ...
    public void readRecords(String sortStr) {
        ...
        List<MovieDataStructure> movies = new TableControllerMovie(this).read("movies", sortStr);
        ...
        if (movies.size() > 0) {
            for (MovieDataStructure obj : movies) {
                ...
                Log.d(LOG_TAG, "ImdbId: " + movieImdbId);

                mListStructure.add(new MovieDataStructure(null, movieTitle, movieYearRelease, movieType, moviePoster, movieImdbId, moviePlot,
                        "", id, movieBGUrl, movieImdbRating, movieTomatoeRating, movieMetaScoreRating, movieDuration, movieGenero,
    ...
    public void onClick(View v) {
        ...
        switch(id){
            case R.id.fab_go_to_top_movie_favoritos:
